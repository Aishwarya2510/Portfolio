  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="ml-4" href="/exp" title="Experiences" />
      ...
      >
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://github.com/Aishwarya2510"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.linkedin.com/in/aishwarya-chourasia-65b381151/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="ml-4 lg:m-0 lg:my-2" href="/exp" title="Experiences" />
