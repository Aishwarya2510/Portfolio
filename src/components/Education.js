    ...
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="Bachelor of Engineering in ELectronics"
            time="2017-2021"
            place="Vivekanand Education Society Institute of Technology"
            
          />

          <Details
            type="Master of Science in Technology Management"
            time="2023-2024"
            place="Univeristy of Illinois at Urbana Champaign"
