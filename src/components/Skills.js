...
<>
    ...
    >
        ...
        <Skill name="Python" x="-20vw" y="2vw" />
          ...
          <Skill name="A/B Testing" x="20vw" y="6vw" />
          <Skill name="ReactJS" x="0vw" y="12vw" />
          <Skill name="JIRA" x="-20vw" y="-15vw" />
          <Skill name="SDLC" x="15vw" y="-12vw" />
          <Skill name="Github" x="-35vw" y="-5vw" />
          <Skill name="Agile" x="32vw" y="-5vw" />
          <Skill name="UI/UX" x="0vw" y="-20vw" />
          <Skill name="Tablaeu" x="-25vw" y="18vw" />
          <Skill name="PowerBI" x="28vw" y="18vw" />
    </div></>
  );
};
